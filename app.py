    ...
    if script_choice == "Acurácia":
        ...
        if uploaded_file is not None:
            try:
                ...
                # Mapeamento de nomes de colunas normalizados para lidar com variações
                column_mapping = {
                ...
                for new_name, old_name in column_mapping.items():
                    if old_name in df.columns:
                        ...
                        st.warning(f"Aviso: Coluna essencial '{old_name}' não foi encontrada. O processamento pode estar incompleto.")
